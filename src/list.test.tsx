...
const DisplayList = ({ items, onClick }: { items: any[]; onClick?: any }) => (
  <ul onClick={onClick}>
    {items.map((item, i) => (
...
describe("List", () => {
  ...
  it("can add one item", async () => {
    const addItem = (items: any[], setItems: any) =>
  ...
  it("can add multiple items", async () => {
    const addItems = (items: any[], setItems: any) => {
  ...
  it("actions have updated items", async () => {
    const ItemList = ({ onClick }: { onClick: any }) => {
      const items = useSelector("items");
      return (
        <DisplayList
          items={items.map((it: any) => `${it.id}-${it.text}`)}
  ...
  describe("array", () => {
    ...
    it(".push() - appends an item", async () => {
      const items: any[] = [];
      const push = (items: any[], setItems: any) => setItems.push(items.length);
    ...
    it(".unshift() - prepends an item", async () => {
      const items: any[] = [];
      const unshift = (items: any[], setItems: any) =>
        setItems.unshift(items.length);
    ...
    it(".concat() - adds items to the end", async () => {
      const concat = (items: any[], setItems: any) =>
        setItems.concat(items.length);
  ...
  describe("array alias", () => {
    it(".append() - an alias of .push()", async () => {
      const append = (items: any[], setItems: any) =>
        setItems.append(items.length);
    ...
    it(".prepend() - an alias of .unshift()", async () => {
      const prepend = (items: any[], setItems: any) =>
        setItems.prepend(items.length);
